...
class IndexController extends Controller {
    ...
    public function index(){
        // session('openid','dddddddddddddddddddddddddddddddddd');
        if(!session('openid')){
            $url = "http://campaign.laneige.com/Silkintense2018/index/getcode";
            if($_GET['smtid']){
            ...
            $url = "http://api.weq.me/wx/authorize.php?id=15132409756023&scope=snsapi_base&redirect_uri=".urlencode($url);
            redirect($url);
        }
    ...
    public function getcode(){
        if(I('get.openid')){
            ...
            $url = 'http://campaign.laneige.com/Silkintense2018/';
            if($_GET['smtid']){
                $url .= "?smtid=".$_GET['smtid'];
            }else{
                if($_GET['smt_cp']) $url .= "?smt_cp=".$_GET['smt_cp'];
